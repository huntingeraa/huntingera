 ...
 const history = useNavigate()
  ...
  return (
    <FormContainer className="p-0 m-0">
      <h1 className="text-center" style={{fontSize:'50px', fontFamily:'Roboto', paddingRight:'190px' }}>Vendor Sign In</h1>
      ...
      <Row className='py-3' style={{textAlign: 'center', paddingRight:'190px'}} >
        <Col>
          New Vendor?{' '}
          <Link to={redirect ? `/vregister?redirect=${redirect}` : '/vregister'}>
            Register
          </Link>
        </Col>
      </Row>
