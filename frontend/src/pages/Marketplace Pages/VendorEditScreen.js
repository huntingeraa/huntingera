...
import { listVendorcreationDetails, updateVendorcreation } from '../../actions/vendorcreationActions'
...
const VendorEditScreen = () => {
  ...
  return (
    ...
    <>
      <Link to='/store/myvendor' className='btn btn-light my-3'>
        Go Back
      </Link>
      <FormContainer>
        <h1>Edit Your Profile Now</h1>
